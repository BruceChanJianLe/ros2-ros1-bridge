...
{
  /* initialize ROS 1 */
  ros::init(argc, argv, "ros2_ros2_bridge");
  ...
  ros1_bridge::Bridge2to1Handles handle = ros1_bridge::create_bridge_from_2_to_1(ros2_node, ros1_nh, std::get<index::ros2_type>(ros2_to_ros1_pair), std::get<index::ros2_topic>(ros2_to_ros1_pair), queue_size, std::get<index::ros1_type>(ros2_to_ros1_pair), std::get<index::ros1_topic>(ros2_to_ros1_pair), queue_size);
